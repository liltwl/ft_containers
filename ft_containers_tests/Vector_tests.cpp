...
/*   Updated: 2022/04/25 06:28:12 by otaouil          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void vector_tests(void)
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        /*------------------ std::vectors ---------------------*/
        ft::Vector<std::string> ft_v1(10, "string2");
        ft::Vector<int> const ft_v2((size_t)10, 9);
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        /*------------------------------------------ test 1: lhs.size == rhs.size ------------------*/
        {
            ...
            ft::Vector<int> ft_v((size_t)100, 5);
            ft::Vector<int> ft_v1((size_t)100, 5);
        ...
        /*------------------------------------------ test 2: lhs.size < rhs.size ------------------*/
        {
            ...
            std::vector<int> v1(100, 5);
            ft::Vector<int> ft_v((size_t)50, 5);
            ft::Vector<int> ft_v1((size_t)100, 5);
        ...
        /*------------------------------------------ test 3: lhs.size > rhs.size ------------------*/
        {
            ...
            ft::Vector<int> ft_v((size_t)100, 5);
            ft::Vector<int> ft_v1((size_t)50, 5);
